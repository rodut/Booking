...
class RegisterTest26(unittest.TestCase):
    ...
    def test_register_26(self):
        ...
        element = wait.until(EC.presence_of_element_located((By.XPATH, Register.booking_business_text)))
