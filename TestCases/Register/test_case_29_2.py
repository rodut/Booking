...
class RegisterTest29second(unittest.TestCase):
    ...
    def test_register_29_second(self):
        ...
        assert element.text == "jacknicholson41@djimail.com"


if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(
        output="C:\\Users\\Tudor\\PycharmProjects\\Booking\\Reports",
        report_name="RegisterTest29_second"))
