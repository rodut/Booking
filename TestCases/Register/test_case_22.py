...
class RegisterTest22(unittest.TestCase):
    ...
    def test_register_22(self):
        ...
        element = wait.until(EC.presence_of_element_located((By.XPATH, Register.make_changes_booking)))
