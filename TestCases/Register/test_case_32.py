...
class RegisterTest32(unittest.TestCase):
#    driver = webdriver.Chrome()
    ...
    def test_register_32(self):
        ...
        time.sleep(1)
        # Enter a valid password in "Create password" field ("123456789")
        register.set_password_address(self.password)
        # Enter a valid password in "Confirm password" field ("123456789")
        ...
        element = wait.until(EC.presence_of_element_located((By.XPATH, Register.confirm_register)))
