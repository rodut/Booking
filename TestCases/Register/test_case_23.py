...
class RegisterTest23(unittest.TestCase):
    ...
    def test_register_23(self):
        ...
        element = wait.until(EC.presence_of_element_located((By.XPATH, Register.all_rights_reserved)))
